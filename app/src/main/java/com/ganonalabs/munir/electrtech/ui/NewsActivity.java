...
public class NewsActivity extends AppCompatActivity {
    ...
    private String imgURI = "https://image.ibb.co/dOrZ1d/collage3.jpg";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sTitle = bundle.getString("title");
         sBody = bundle.getString("description");
      ...
      /*  FloatingActionButton fab = (FloatingActionButton) findViewById(R.id.fab);
        ...
        if(imgURI != null){
            Picasso.with(getApplicationContext()).load(imgURI).into(image_banner);
        }
        ...
        if(!resolveInfos.isEmpty()){
            for(ResolveInfo resInfo : resolveInfos){
                ...
                if(!packageName.contains("com.facebook.katana")){
                    ...
                    intent.putExtra(Intent.EXTRA_TEXT, sBody + "\n" + "Sent from" + "   "+ getString(R.string.invitation_deep_link));
